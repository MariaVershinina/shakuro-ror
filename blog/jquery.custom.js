...
;(function($) {
  ...
  $(document).ready(function($) {
    ...
    if ( $commentform.length ) {
      ...
      $formSubmit.append($cancelComment);
      $commentTextarea.css({
        height : 50
      });
      $commentform.addClass('comment-form-close').css({
        height : 50,
        overflow : 'hidden'
      }).on('click', function() {
        var $this = $(this);
        $this.animate({
          ...
          $commentform.removeClass('comment-form-close');
        });
        ...
        $cancelComment.on('click', function(e) {
          ...
          $this.animate({
            ...
            $commentform.addClass('comment-form-close')
            $commentTextarea.css({
              height : 50
            });
          });
